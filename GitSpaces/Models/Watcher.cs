...
public class Watcher : IDisposable
{
    ...
    void OnRepositoryChanged(object o, FileSystemEventArgs e)
    {
    ...
    void OnWorkingCopyChanged(object o, FileSystemEventArgs e)
    {
        if (string.IsNullOrEmpty(e.Name)) return;
    ...
    FileSystemWatcher _repoWatcher;
    FileSystemWatcher _wcWatcher;
    Timer _timer;
    int _lockCount;
    long _updateWC;
    long _updateBranch;
    long _updateSubmodules;
    long _updateStashes;
    long _updateTags;
}
