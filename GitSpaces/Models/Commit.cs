...
public class Commit
{
    ...
    public string FullMessage => string.IsNullOrWhiteSpace(Message) ? Subject : $"{Subject}\n\n{Message}";
    ...
    static readonly DateTime _utcStart = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc).ToLocalTime();
}
