...
{
    public static string SelectedServer { get; set; } = "https://www.gravatar.com/avatar/";

    static AvatarManager()
    {
        _storePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "GitSpaces", "avatars");
    ...
    static void NotifyResourceChanged(string md5)
    {
    ...
    static readonly string _storePath = string.Empty;
    static readonly List<IAvatarHost> _avatars = new();
    static readonly Dictionary<string, Bitmap> _resources = new();
    static readonly HashSet<string> _requesting = new();
}
