...
{
    public bool HasSpecifiedLocalBranch { get; private set; }
    ...
    public List<Branch> LocalBranches { get; }
    ...
    public Push(Repository repo, Branch localBranch)
    {
        _repo = repo;

        // Gather all local branches and find current branch.
        LocalBranches = new();
        var current = null as Branch;
    ...
    void AutoSelectBranchByRemote()
    {
        ...
        var fake = new Branch
        {
            Name = $"{_selectedLocalBranch.Name} (new)", Remote = _selectedRemote.Name
        };
        branches.Add(fake);
        RemoteBranches = branches;
    ...
    Branch _selectedLocalBranch;
    Remote _selectedRemote;
    List<Branch> _remoteBranches = new();
    Branch _selectedRemoteBranch;
}
