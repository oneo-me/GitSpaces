...
{
    public AvaloniaList<LauncherPage> Pages { get; private set; }
    ...
    public void OpenRepositoryInTab(RepositoryNode node, LauncherPage page)
    {
        ...
        repo.Open();
        AutoFetch.AddRepository(repo.FullPath);
    ...
    void CloseRepositoryInTab(LauncherPage page)
    {
        if (page.Data is Repository repo)
        {
            AutoFetch.RemoveRepository(repo.FullPath);
            repo.Close();
        }
