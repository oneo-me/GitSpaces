...
public partial class InitGitFlow : Popup
{
    ...
    public static ValidationResult ValidateBaseBranch(string _, ValidationContext ctx)
    {
        ...
        {
            if (initializer._master == initializer._develop) return new("Develop branch has the same name with master branch!");
        }
    ...
    public static ValidationResult ValidateTagPrefix(string tagPrefix, ValidationContext ctx)
    {
        ...
        {
            return new("Bad tag prefix format!");
        }
    ...
    public override Task<bool> Sure()
    {
        ...
        return Task.Run(() =>
        {
            var succ = new GitFlow(_repo.FullPath).Init(_repo.Branches, _master, _develop, _featurePrefix, _releasePrefix, _hotfixPrefix, _tagPrefix);
            if (succ)
            {
    ...
    string _develop = "develop";
    string _featurePrefix = "feature/";
    string _releasePrefix = "release/";
    string _hotfixPrefix = "hotfix/";
    string _tagPrefix = string.Empty;
}
